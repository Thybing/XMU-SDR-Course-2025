...
def detect_preamble_by_energy(signal):
    ...
    energy_threshold = estimate_noise_threshold(energy, 30, 16)
    # 绘图
...
data_starts = detect_preamble_by_energy(received_signal_weak)
print("weak signal data_start:", end='')
print(data_starts)
print("weak signal psnr {}".format(
    estimate_snr(received_signal_weak, slice(data_starts[0] - 320, data_starts[0]), slice(30))))
