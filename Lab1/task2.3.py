...
sts_starts = detect_preamble_cross_correlation(preamble_sts, received_signal_weak)
sts_starts = np.array(sts_starts)
data_starts = sts_starts + (10 * len_sts + int(2.5 * len_lts))
print("weak signal data starts calculated by preamble_sts:", end='')
print(data_starts)

lts_starts = detect_preamble_cross_correlation(preamble_lts, received_signal_weak)
lts_starts = np.array(lts_starts)
data_starts = lts_starts + (2 * len_lts)
print("weak signal data starts calculated by preamble_lts:", end='')
print(data_starts)
